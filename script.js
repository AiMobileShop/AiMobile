...
const translations = {
  ...
  hero_title: { en: "AI Mobile And Computer", hi: "एआई मोबाइल एंड कंप्यूटर", mr: "एआय मोबाईल अँड कॉम्प्युटर", ur: "اے آئی موبائل اینڈ کمپیوٹر" },
  ...
  prod_no_results: { en: "No products found matching your search.", hi: "आपकी खोज से मेल खाने वाले कोई उत्पाद नहीं मिले।", mr: "तुमच्या शोधानुसार कोणतीही उत्पादने आढळली नाहीत.", ur: "آپ की तलाश के अनुसार कोई प्रोڈکٹ نہیں ملا۔" },
  ...
  contact_loc_val: { en: "AI Mobile And Computer, Near Main Bazaar, India", hi: "एआई मोबाइल एंड कंप्यूटर, मुख्य बाजार के पास, भारत", mr: "एआय मोबाईल अँड कॉम्प्युटर, मुख्य बाजारपेठेजवळ, भारत", ur: "اے آئی موبائل اینڈ کمپیوٹر، نزد مین بازار، بھارت" },
